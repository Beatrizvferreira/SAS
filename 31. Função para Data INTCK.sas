DATA FUNCAO_INTNX;
 	SET SASHELP.SHOES;
 	IF REGION = "Africa" THEN DT_INI = MDY(02,01,2021);
	...
	dt_final = intnx("month",DT_INI,2); /*Avança ou Retrocede datas*/
/* 	dt_final = intnx(parâmetro da avanço - dia/mês/ano/trimestre,
	...
	dif_meses = intck("month",dt_ini,dt_final); /*Calcula a quantidade de dias/mês/ano entre duas datas*/
